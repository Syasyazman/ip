...
public class Ui {
    ...
    public void showInvalidEventFormatError() {
        System.out.println("??????????????????????????????????????????????????????????????\n");
        System.out.println("Oh no !! Your format should be \"event <task> /at <date>\" \n");
        System.out.println("??????????????????????????????????????????????????????????????\n");
    }

    public void showInvalidDeadlineFormatError() {
        System.out.println("??????????????????????????????????????????????????????????????\n");
        System.out.println("Oh no !! Your format should be \"deadline <task> /by <date>\" \n");
        System.out.println("??????????????????????????????????????????????????????????????\n");
    }
    ...
    public void showInvalidEditDateOfTaskError() {
        System.out.println("??????????????????????????????????????????????????????????????\n");
        System.out.println("Oh no !! Your format should be \"edit <task number> <new date>\" \n");
        System.out.println("??????????????????????????????????????????????????????????????\n");
    }

    public void showInvalidTaskTypeEditError() {
        System.out.println("??????????????????????????????????????????????????????????????\n");
